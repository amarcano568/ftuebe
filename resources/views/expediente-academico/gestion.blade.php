...
<input type="text" id="file-pdf" value="{{$pdf}}" style="display: none;">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <a href="#" id="btn-print-expediente"><i class="text-primary fa-2x fas fa-print"></i></a>
                                &nbsp;&nbsp;
...
@include('expediente-academico.modal-expediente-academico')
@endsection
@section('javascript')
