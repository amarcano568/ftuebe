...
<body>
    ...
    <main>  
        ...
        <div class="row">
            ...
            <div class="col-xs-9">
                <p style="text-align:justify">
                    Que <strong>{{$alumno->strNombre}} {{$alumno->strApellidos}}</strong>, de nacionalidad {{ $alumno->nacionalidad}}, con
                    {{$alumno->documento}} núm. {{$alumno->strNif}}, y residente de {{$alumno->strProvinciaNacimiento}}, {{$alumno->pais}}
                    estará {{$alumno->alojado}} del {{$alumno->desde}} al {{$alumno->hasta}} en la residencia de
                    esta institución.
                </p>
            </div>
        </div>
